...
class LieusControllerTest < ActionController::TestCase
  ...
  test "should create lieu" do
    assert_difference('Lieu.count') do
      post :create, lieu: { commentaire: @lieu.commentaire, nom: @lieu.nom, recommandation: @lieu.recommandation }
    end
  ...
  test "should update lieu" do
    patch :update, id: @lieu, lieu: { commentaire: @lieu.commentaire, nom: @lieu.nom, recommandation: @lieu.recommandation }
    assert_redirected_to lieu_path(assigns(:lieu))
  end
